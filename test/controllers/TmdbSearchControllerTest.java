 ...
 * <p>
 * Verifies controller endpoints return expected HTTP status codes for success and failure cases,
...
public class TmdbSearchControllerTest extends WithApplication {
    ...
    protected Application provideApplication() {
        ...
        FinancialPerformanceService financialPerformanceService = Mockito.mock(FinancialPerformanceService.class);
        ...
        Mockito.when(dummyMovie.getProductionCompanies()).thenReturn(List.of(new ProductionCompany(1, "", "TestCo", "US")));
        ...
        PersonKnownForPageDTO dummyKnownForPage = new PersonKnownForPageDTO(
                java.util.List.of(new PersonKnownForItemDTO(1, "movie", "Test", "2000-01-01", 1.0, 1.0, 1, "https://example.com")),
        ...
        return new GuiceApplicationBuilder()
                ...
                .overrides(
                        ...
                        bind(FinancialPerformanceService.class).toInstance(financialPerformanceService),
