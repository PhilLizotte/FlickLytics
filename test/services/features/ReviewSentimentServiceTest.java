...
public class ReviewSentimentServiceTest extends WithApplication{
    ...
    // I couldn't get the @BeforeEach tag to work, so I'm just going to call this at the top of every test. 
     ...
     * regardless of if it's touching words or not, in terms of the sentiment calculation.
     * 
    ...
    public void spacialCharactersReviewTest()
    {
        ...
        assertEquals("special chars preservation", review.getReviews().get(0), "bad $%^&fun      fun   $%^& 4564156489      bad");
